...
const PRODUCTS = [
  ...
  { id: 2, title: 'Kit Identidade Visual', description: 'Logo + cartao + papelaria completa', price: 'R$ 597', available: true, image: null },
  { id: 3, title: 'Branding Premium', description: 'Identidade completa com manual de marca', price: 'R$ 1.297', available: true, image: null },
  { id: 4, title: 'Pack Redes Sociais', description: 'Templates editaveis para Instagram e mais', price: 'Em breve', available: false, image: null },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-14 border-l-2 border-[rgba(201,168,76,0.4)] pl-6">
          ...
          <p className="text-[rgba(240,237,230,0.38)] text-sm tracking-wide max-w-md">
            Solucoes criativas para a sua marca
          </p>
        </div>
